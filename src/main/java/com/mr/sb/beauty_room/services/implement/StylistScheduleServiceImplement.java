...
@Service
public class StylistScheduleServiceImplement implements IStylistScheduleService {
 ...
 public StylistScheduleServiceImplement(StylistScheduleRepository stylistScheduleRepository, StylistRepository stylistRepository) {
