...
Backend Spring Boot (Java 21, Boot 3.2.3, MariaDB) para agendamiento de citas en salones de belleza. SaaS multitenant (Fase 0 COMPLETADA) con bot de Telegram (Fases 2-4 COMPLETADAS). Toda la documentación del proyecto está en español en la raíz.
